...
~~~ javascript
//导入方法
import { Point, getTheDistanceOfAPointLineSegment } from 'easy-util-tools'
...
~~~ javascript
//导入方法
import { Point, getTheDistanceFromPointToLine } from 'easy-util-tools'
...
~~~ javascript
//导入方法
import { Point, determineIfAPointIsWithinAnotherPointArea } from 'easy-util-tools'
